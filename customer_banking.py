...
def main():
    ...
    print("Update Balance: $", format(updated_savings_balance, ',.2f'))
    ...
    cd_maturity = int(input('What is the length of months you want calculate the interest gained on the account? ')) 
    ...
    print("Updated CD Balnce: $", format(updated_cd_balance, ',.2f'))
    print("Interest Earned: $", format(interest_earned, ',.2f'))
